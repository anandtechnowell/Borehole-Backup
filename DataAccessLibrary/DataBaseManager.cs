...
namespace DataAccessLibrary
{
    public class DataBaseManager
    {
            ...
            string strpgcon = ConfigurationManager.ConnectionStrings["pgsqlMain"].ConnectionString;
        ...
        public DataSet Update_Return(NpgsqlCommand _cmd)
        {
            try
            {
                cmd = _cmd;
        ...
        public DataSet verify_login(NpgsqlCommand _cmd)
            {
                lock (obj_lock)
                {
                    cmd = _cmd;
